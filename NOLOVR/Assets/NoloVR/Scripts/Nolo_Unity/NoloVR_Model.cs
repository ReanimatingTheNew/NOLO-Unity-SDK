...
public class NoloVR_Model : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        touchpad = transform.FindChild("buttons/button_touchpad");
        menu = transform.FindChild("buttons/button_menu");
        system = transform.FindChild("buttons/button_system");
        grip_left = transform.FindChild("buttons/button_grip_left");
        grip_right = transform.FindChild("buttons/button_grip_right");
        trigger = transform.FindChild("buttons/button_trigger");
    }
    void Update()
    {
